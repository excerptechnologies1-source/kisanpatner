...
const FarmerRegistration: React.FC = () => {
  ...
  const renderStep1 = () => (
    <View className="mb-5">
      <Text className="text-lg font-semibold text-[#1FAD4E] mb-4">
        Personal & Location
      </Text>
      ...
      <View className="mb-3">
        <Text className="text-sm font-medium text-gray-800 mb-1.5">Taluk</Text>
        <TextInput
          className="border border-gray-300 rounded-lg px-3 py-2.5 text-base bg-gray-100"
      ...
      <View className="mb-3">
        <Text className="text-sm font-medium text-gray-800 mb-1.5">Post</Text>
        <TextInput
          className="border border-gray-300 rounded-lg px-3 py-2.5 text-base bg-gray-100"
    ...
    <View className="mb-5">
      ...
      {role === 'farmer' && (
        <>
          ...
          <Text className="text-base font-semibold text-gray-800 mt-3 mb-3">
            Farm Land (Acres)
          </Text>
        ...
        return (
          ...
          >
            <View className="flex-row items-center justify-between">
              ...
              >
                <Text className="text-[#1FAD4E] text-xs font-semibold">
                  Upload
                </Text>
              </TouchableOpacity>
            </View>
  ...
  return (
    <View className="flex-1 bg-white py-10 mb-8">
      <ScrollView
      ...
      >
        <View className="p-5">
          <View className="items-center mb-5">
            <Text className="text-2xl font-bold text-[#1FAD4E]">
              {role === 'farmer' ? 'Farmer' : 'Trader'} Registration
            </Text>
            <Text className="text-xs text-gray-500 mt-1">
          ...
          <View className="flex-row justify-between mt-5 gap-3">
            {currentStep > 1 && (
              ...
              >
                ...
                <Text className="text-[#1FAD4E] text-base font-semibold ml-2">
                  Previous
                </Text>
              </TouchableOpacity>
            )}
          ...
          <View className="flex-row justify-center mt-6">
            ...
            <TouchableOpacity onPress={() => router.push('/(auth)/Login')}>
              <Text className="text-sm text-[#1FAD4E] font-semibold">
                Login here
              </Text>
            </TouchableOpacity>
          </View>
