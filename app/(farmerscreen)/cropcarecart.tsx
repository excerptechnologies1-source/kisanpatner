...
//             ]}
//           >
//             <Text className="text-white font-medium text-sm">{notification.message}</Text>
//           </Animated.View>
//         )}
...
//               </View>
//               <Text className="text-2xl font-medium text-[#333] mb-3 text-center">Login Required</Text>
...
//                     <Text className="text-[#2c5f2d] text-xs font-medium">
...
//                   </View>
//                   <Text className="text-xl font-medium text-[#333] mb-2 text-center">Your cart is empty</Text>
...
//                               <View>
//                                 <Text className="text-[15px] font-medium text-[#333] leading-5 mb-1" numberOfLines={1}>
//                                   {item.seedName}
//                                 </Text>
...
//                                     <Text className="text-sm font-medium text-[#333]">{item.quantity}</Text>
//                                   </View>
//                                   <TouchableOpacity
...
//                         <Text className="text-lg font-medium text-[#333] mb-4">
//                           Order Summary
//                         </Text>
...
//                           <Text className="text-base font-medium text-[#333]">Total Amount</Text>
//                           <Text className="text-xl font-medium text-[#2c5f2d]">₹{cart.total.toFixed(2)}</Text>
//                         </View>
...
//                             <Text className="text-white text-sm font-medium ml-2">Proceed to Checkout</Text>
//                           </TouchableOpacity>
