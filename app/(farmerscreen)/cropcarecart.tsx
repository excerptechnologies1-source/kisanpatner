...
// // import { ShoppingCart, Trash2, Plus, Minus, ArrowLeft, CreditCard } from 'lucide-react-native';
...
// //         }
// //       } else {
// //         showNotification('error', 'Please login to view cart');
// //       }
// //     } catch (error) {
...
// //     try {
// //       const response = await fetch(`${CART_API_URL}/cart/${user._id}`);
...
// //             setLoading(prev => ({ ...prev, cart: true }));
// //             try {
// //               const response = await fetch(`${CART_API_URL}/cart/clear/${user._id}`, {
// //                 method: 'DELETE',
// //               });
...
// //     // Navigate to checkout page using Expo Router
// //     router.push('/transporterpages/cropcarecheckout');
// //   };
...
// //           <TouchableOpacity
// //             onPress={() => router.push("/transporterpages/cropcare")}
