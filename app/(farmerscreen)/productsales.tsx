...
// // Custom Picker component with improved styling - Replaced with Tailwind Dropdown Modal
...
//  // Replace your existing fetchMarkets function with this:
...
//     // Fetch farmer details to get their nearest markets
...
//     // Filter markets that are in farmer's nearestMarkets array
...
//           showAppAlert("Info", `Only ${newPhotos.length} photo(s) added (3 photo limit)`);
//         }
//       }
//     } catch (error) {
...
//       if (currentPhotos >= 5) {
//         showAppAlert("Limit Reached", "Maximum 5 photos per grade");
//         return;
//       }
...
//         if (newPhotos.length < result.assets.length) {
//           showAppAlert("Info", `Only ${newPhotos.length} photo(s) added (5 photo limit)`);
//         }
//       }
//     } catch (error) {
...
//         gp.photos.forEach((photo: any, index: number) => {
...
//     try {
//       console.log("Submitting product with data:", JSON.stringify(formData));
...
//       showAppAlert("Error", error.response?.data?.message || "Failed to submit. Please check your connection and try again.");
//     }
//   };
...
//                   📷 Upload Photos/Videos ({gp.photos.length}/5)
//                 </Text>
//               </TouchableOpacity>
...
// const compressImage = async (uri: string, quality: number = 0.3) => {
//   try {
...
//           updated[index] = {
//             ...updated[index],
//             photos: [...updated[index].photos, ...compressedPhotos],
//           };
//           return updated;
//         });

//         if (selectedPhotos.length < result.assets.length) {
//           showAppAlert("Info", `Only ${selectedPhotos.length} photo(s) added (5 photo limit)`);
//         }
//       }
//     } catch (error) {
//       console.error("Error uploading grade photos:", error);
...
//       console.log("Submit success:", response.data);
//       showAppAlert("Success", "Product added successfully!", () => router.back());
//     } catch (error: any) {
//       console.error("Submit error details:", error.response?.data || error.message);
