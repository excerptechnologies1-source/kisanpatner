      ...
      <View className="bg-white px-5 py-10 ">
        ...
        <View className="flex-row mb-3">
          ...
          >
            ...
            <Text className="text-[11px] text-emerald-800">Grow · Sell</Text>
            <Text className="text-[11px] text-emerald-800">Manage</Text>
          </TouchableOpacity>
          ...
          >
            ...
            <Text className="text-[11px] text-orange-800">Buy · Bid</Text>
            <Text className="text-[11px] text-orange-800">Settle</Text>
          </TouchableOpacity>
        </View>
        ...
        >
          ...
          <Text className="text-[11px] text-blue-800">Work · Track</Text>
          <Text className="text-[11px] text-blue-800">Assist</Text>
        </TouchableOpacity>
